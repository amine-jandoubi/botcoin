...
public class KrakenApi {
    ...
    public static <T> T queryPublic(Method method, Map<String, String> parameters, Class<T> type) {
        try {
            ApiRequest request = new ApiRequest();
            request.setMethod(method);
            ...
            return JsonUtils.toObject(request.execute(), type);
    ...
    public static <T> T queryPublic(Method method, Class<T> type) throws IOException {
        return queryPublic(method, null, type);
    }
    ...
    public String queryPublic(Method method) throws IOException {
        return queryPublic(method, new HashMap<>());
    }
